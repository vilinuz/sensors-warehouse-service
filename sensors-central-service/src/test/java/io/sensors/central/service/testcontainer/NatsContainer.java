package io.sensors.central.service.testcontainer;
...
public class NatsContainer extends GenericContainer<NatsContainer> {
    ...
    private final static Path NATS_DOCKERFILE = Paths.get("..")
            .toAbsolutePath().resolve(Paths.get("nats", "Dockerfile"));


    public NatsContainer() {
        super(new ImageFromDockerfile("sensor-nats-server")
                .withDockerfile(NATS_DOCKERFILE));
